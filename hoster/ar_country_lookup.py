...
class ArtistCountryLookupQuery(Query):

    def names(self):
        return ("artist-mbid-country-code", "MusicBrainz Artist MBID Country Lookup")

    def inputs(self):
        return ['artist_mbid']

    def introduction(self):
        return """Given artist MBIDs look up areas for those artists. Any artist_mbids
